...
#pragma HLS INTERFACE m_axi port=global_A offset=slave bundle=gmem0 depth=64
#pragma HLS INTERFACE m_axi port=global_B offset=slave bundle=gmem1 depth=64
#pragma HLS INTERFACE m_axi port=global_C offset=slave bundle=gmem2 depth=64
