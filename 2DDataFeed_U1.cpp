...
#pragma HLS PIPELINE II=1
    ap_uint<14> buffer_ind_to_feed_to_sys_arr;
...
#pragma HLS INLINE off
  ...
  ap_uint<12> transfer_counter = 0;
  ap_uint<12> data0_buf_size;
  ap_uint<12> local_transfer_size;
  bool more_to_write_to_buffer = true;
  bool more_to_feed_to_sys_arr = false;
  bool more_to_forward = true;
  ap_uint<11> buffer_write_counter = 0;
  ap_uint<1> buffer_gs_id = 0;

  // the first read
  unsigned int FILTER_S = 1;
  data0_buf_size = 8192 / U1_DATA0_FC_SIMD_FACTOR;
...
#pragma HLS PIPELINE II=1
    ...
    ap_uint<11> buffer_ind_to_write_to_buffer = buffer_write_counter;
...
#pragma HLS INLINE off
  ...
  // the first read
  unsigned int FILTER_S = 1;
  data1_buf_size = 8192 / U1_DATA1_FC_SIMD_FACTOR;
